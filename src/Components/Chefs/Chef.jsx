...
const Chef = () => {
    const chefs = [
        ...
        {
            name: "Angelo Maestro",
            img : "https://img.freepik.com/free-photo/smiling-young-male-chef-holding-broccoli-red-bell-pepper-his-hands_23-2147863601.jpg?w=740&t=st=1725257670~exp=1725258270~hmac=e926f2613e2b609d0c2a98ec9cb24cd9260af7f4dca2bfae4947a5b08c257b57"
        },
        {
            name: "George Smith",
        ...
        <div className="grid md:grid-cols-4 grid-cols-1 gap-10 mt-10">
            {
                ...
                {/* Card Image */}
                <img width={350} height={190} className="h-[200px] w-[300px] rounded-2xl bg-gray-400" src={chef.img} alt="card navigate ui" />
                {/* Card Heading */}
                <div className="space-y-2">
                    <h2 className="font-medium text-slate-800 p-2 text-center sm:text-lg md:text-xl dark:text-white/90">{chef.name}</h2>
                </div>
